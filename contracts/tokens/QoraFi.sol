...
/**
 * @title QoraFi DAO
 * @dev The QoraFi DAO is a decentralized governance token, with rewards minting, and a multi-destination fee system govern by decentralized autonomous organization.
