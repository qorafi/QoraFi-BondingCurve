 ...
 * @notice A gas-efficient ledger for delegator and user node level data, controlled by the DAO.
 * @dev This contract also acts as the bridge to fund the pool rewards.
 */
